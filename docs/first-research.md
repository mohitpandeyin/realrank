...
The current implementation reference is the [locked Terracotta wireframe](wireframes/realrank-locked-terracotta.html). The following decisions supersede conflicting recommendations later in this historical research note:
...
- The conversion form contains Entity Name, Contact or WhatsApp Number and **Rank Amount**, with a ₹10 minimum, ₹10 steps and **List your Entity** as the action. The primary action is end-aligned within its responsive grid area.
...
- The public section is called **RealRank Index** and is introduced with **“Compare companies and marketers, explore portfolios, and connect directly.”** Indore is not repeated in the section heading because the city selector and launch-status pill already establish the location.
